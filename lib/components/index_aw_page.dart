...
import 'package:awjq/model/userinfo.dart';
...
import 'package:awjq/components/widget/flj_sign_widget.dart';
...
class IndexAwPage extends BaseWidget {
  IndexAwPage({Key key, this.isShow = false, this.id}) : super(key: key);
  final bool isShow;
  final int id;
  ...
  State<StatefulWidget> cState() {
    ...
    return _IndexAwPageState();
  }
}

class _IndexAwPageState extends BaseWidgetState<IndexAwPage> {
  ...
  void getPageData() async {
    ElementModel data = await getFisrtTopNavConfig(nav_id: widget.id);
    if (data == null) {
      netWorkErr = true;
      setState(() {});
      return;
  ...
  @override
  void didUpdateWidget(covariant IndexAwPage oldWidget) {
