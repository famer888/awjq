...
import 'package:awjq/components/nakedchat_page.dart';
...
import 'package:awjq/views/yyq/cards/acg_double_colume_card.dart';
  ...
  getSearchList() async {
    ...
    switch (widget.type) {
      ...
      case 4:
        ...
        break;
      case 5:
        res = await searchCommunity(
            page: page, limit: limit, word: widget.value, type: "fish");
        break;
      case 6:
