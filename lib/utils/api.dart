...
import 'package:awjq/model/animationDetail.dart';
import 'package:awjq/model/appcenter.dart';
import 'package:awjq/model/basic.dart';
import 'package:awjq/model/coindetail.dart';
import 'package:awjq/model/coinorvip.dart';
import 'package:awjq/model/comicReading.dart';
import 'package:awjq/model/comicsDetail.dart';
import 'package:awjq/model/construct.dart';
import 'package:awjq/model/element.dart';
import 'package:awjq/model/feedback.dart';
import 'package:awjq/model/home_package_list_construct.dart';
import 'package:awjq/model/home_pure_list_construct.dart';
import 'package:awjq/model/homedata.dart';
import 'package:awjq/model/invitionlist.dart';
import 'package:awjq/model/myinvitation.dart';
import 'package:awjq/model/myreward.dart';
import 'package:awjq/model/ranklistConstruct.dart';
import 'package:awjq/model/series_model.dart';
import 'package:awjq/model/systemnotice.dart';
import 'package:awjq/model/systemnoticelist.dart';
import 'package:awjq/model/updateNum.dart';
import 'package:awjq/model/videolist.dart';
import 'package:awjq/model/welfare_model.dart';
...
Future<Basic> communitySortList(
    {int id, String sort, int page, int limit = 15, String type = ""}) async {
  try {
    Response<dynamic> res =
...
//话题详情
Future<Basic> communityTopicsDetail({String topic_id, String type = ""}) async {
  try {
    Response<dynamic> res = await PlatformAwareHttp.post(
...
/// 帖子搜索
Future searchCommunity(
    {int page, int limit, String word, String type = ""}) async {
  try {
    Response<dynamic> res = await PlatformAwareHttp.post(
