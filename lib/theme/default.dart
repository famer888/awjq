...
class GQStyle {
  static LinearGradient gradient_90_114 = LinearGradient(
    // colors: [Color(0xff00edfd), Color(0xffbbe954)],
    colors: [Color.fromRGBO(90, 75, 235, 1), Color.fromRGBO(114, 98, 242, 1)],
    begin: Alignment.centerLeft,
    end: Alignment.centerRight,
  );

  static LinearGradient gradient_228_246 = LinearGradient(
    // colors: [Color(0xff00edfd), Color(0xffbbe954)],
    colors: [
  ...
  static Color blueColor81_151_241 = Color.fromRGBO(94, 79, 236, 1);

  static Color cyanColor00edfd = Color.fromRGBO(94, 79, 236, 1);

  static Color jellyCyanColor103224185 = Color.fromRGBO(94, 79, 236, 1);
  ...
  static TextStyle graya8f8f8f_11 = TextStyle(
      fontFamily: hanyi,
      color: Color.fromRGBO(149, 148, 156, 1),
      fontSize: ScreenUtil().setSp(11),
      overflow: TextOverflow.ellipsis,
      decoration: TextDecoration.none);
  ...
  static TextStyle blue80_11 = TextStyle(
      fontFamily: hanyi,
      color: Color.fromRGBO(94, 79, 236, 1),
      fontSize: ScreenUtil().setSp(11),
      overflow: TextOverflow.ellipsis,
      decoration: TextDecoration.none);
  ...
  static TextStyle gray102_15 = TextStyle(
      fontFamily: hanyi,
      color: Color.fromRGBO(102, 102, 102, 1),
      fontSize: ScreenUtil().setSp(15),
      overflow: TextOverflow.ellipsis,
