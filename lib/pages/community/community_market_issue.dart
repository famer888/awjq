...
import 'package:awjq/pages/community/xfile_progresstoast.dart';
...
class CommunityMarketIssue extends BaseWidget {
  CommunityMarketIssue({Key key}) : super(key: key);

  @override
  State<StatefulWidget> cState() {
    // TODO: implement cState
    return _CommunityMarketIssueState();
  }
}

class _CommunityMarketIssueState extends BaseWidgetState<CommunityMarketIssue> {
  Map setLabel = {};
  List<dynamic> labels = [];
  ...
  _upData() {
    ...
    if (contact.isEmpty) {
      CommonUtils.showText(CommonUtils.txt("srlxfs"));
      return;
    }
    if (video.isNotEmpty && upList.isEmpty) {
      CommonUtils.showText(CommonUtils.txt("tjfm"));
      return;
    }
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        contentPadding: EdgeInsets.symmetric(
                            horizontal: ScreenUtil().setWidth(8)),
                        hoverColor: Colors.white,
                        hintText: CommonUtils.txt('rucpjs'),
                        hintStyle: TextStyle(
                          color: Color(0xffa1a2a9),
                          fontFamily: GQStyle.hanyi,
                          fontSize: ScreenUtil().setSp(15),
              ...
              children: [
                ...
                RichText(
                    ...
                    text: TextSpan(
                        ...
                        children: [
                          TextSpan(
                              text: CommonUtils.txt("sctpjs"),
                              style: GQStyle.white255_15_M),
                          TextSpan(
                              text: " " + CommonUtils.txt("zdjzbkbxt"),
                ...
                Row(
                  children: [
                    Text(
                      CommonUtils.txt("scspjs"),
                      style: GQStyle.white255_15_M,
                    ),
                    SizedBox(width: ScreenUtil().setWidth(10)),
                    Text(
                      CommonUtils.txt("zdybmxt"),
                      style: GQStyle.gray208_13,
                    )
                  ],
                ),
