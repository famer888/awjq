...
class CommunityBitPostReview extends StatefulWidget {
  CommunityBitPostReview({
    Key key,
    this.data,
    this.isSecond = false,
    this.replyCall,
  ...
  @override
  State<CommunityBitPostReview> createState() => _CommunityBitPostReviewState();
}

class _CommunityBitPostReviewState extends State<CommunityBitPostReview> {
  dynamic _data;
  ...
  @override
  void didUpdateWidget(covariant CommunityBitPostReview oldWidget) {
    _data = widget.data;
    _comments = _data["comments"] == null ? [] : List.from(_data["comments"]);
    //回复超过5条就显示更多评论
    _tcoments = _comments.length > max ? _comments.sublist(0, max) : _comments;
