...
import 'package:awjq/pages/community/home_community.dart';
...
class _HomeState extends State<Home> {
  ...
  _initPlatformState() async {
    await Flurry.initialize(
      androidKey: "XCJW6K6GS3M5NZ8NDSZM",
      iosKey: "5KGM9RX3D2K6YV9ZKSZ3",
    );
  }
  ...
  void getClipboardText() {
    if (kIsWeb) {
      ...
      String aff = u.queryParameters['awjq_aff'];
      if (aff != null) {
  ...
  Widget build(BuildContext context) {
    ...
    Config cf = Provider.of<HomeConfig>(context, listen: true).config;
    return Scaffold(
                        ...
                        member != null && member.reg_tip.length > 0
                            ? GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  color: Color.fromRGBO(94, 79, 236, 0.2),
                                  child: Row(
                                    mainAxisAlignment:
