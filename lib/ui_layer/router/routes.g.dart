      ...
      branches: [
        ...
        StatefulShellBranchData.$branch(
          routes: [
            GoRouteData.$route(
              path: '/xianYu',
              factory: $XianYuRouteExtension._fromState,
            ),
          ],
        ),
        StatefulShellBranchData.$branch(
...
extension $XianYuRouteExtension on XianYuRoute {
  static XianYuRoute _fromState(GoRouterState state) => const XianYuRoute();
...
extension $CommunityIssueRouteExtension on CommunityIssueRoute {
  static CommunityIssueRoute _fromState(GoRouterState state) =>
      CommunityIssueRoute(
        _$CommunityIssueTypeEnumMap._$fromName(state.pathParameters['type']!),
      );

  String get location => GoRouteData.$location(
        '/communityIssue/${Uri.encodeComponent(_$CommunityIssueTypeEnumMap[type]!)}',
      );
...
RouteBase get $xianYuIssueRoute => GoRouteData.$route(
      path: '/xianYuIssue',
      parentNavigatorKey: XianYuIssueRoute.$parentNavigatorKey,
      factory: $XianYuIssueRouteExtension._fromState,
    );

extension $XianYuIssueRouteExtension on XianYuIssueRoute {
  static XianYuIssueRoute _fromState(GoRouterState state) =>
...
extension $CommunityModuleRouteExtension on CommunityModuleRoute {
  static CommunityModuleRoute _fromState(GoRouterState state) =>
      CommunityModuleRoute(
        ...
        noLive: _$boolConverter(state.uri.queryParameters['no-live']!),
