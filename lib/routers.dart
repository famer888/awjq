import 'package:awjq/pages/community/community_market_issue.dart';
import 'package:awjq/pages/welfare/welfare_page.dart';
import 'package:bot_toast/bot_toast.dart';
import 'package:flutter/material.dart';
import 'package:awjq/pages/community/community_seltag_page.dart';
import 'package:awjq/pages/community/picview_page.dart';
import 'package:awjq/pages/mine/collect_page.dart';
import 'package:awjq/pages/mine/mine_post_page.dart';
import 'package:awjq/pages/mine/original_enter.dart';
import 'package:awjq/pages/welfare/welfare_task_alone_page.dart';
import 'package:go_router/go_router.dart';
import 'package:awjq/acg_page/category/home_category_page.dart';
import 'package:awjq/acg_page/home/home_comic_choose_chapter_download_page.dart';
import 'package:awjq/acg_page/home/home_comic_download_page.dart';
import 'package:awjq/acg_page/home/home_comic_info_page.dart';
import 'package:awjq/acg_page/home/home_comic_reader_page.dart';
import 'package:awjq/acg_page/home/home_more_and_more_page.dart';
import 'package:awjq/acg_page/home/home_recently_updated_page.dart';
import 'package:awjq/acg_page/home/home_sign_page.dart';
import 'package:awjq/acg_page/home/home_video_collect_page.dart';
import 'package:awjq/page/action_trailer_story.dart';
import 'package:awjq/page/ktload_webview.dart';
import 'package:awjq/page/local_video_detail.dart';
import 'package:awjq/page/more_and_more_carton.dart';
import 'package:awjq/page/more_and_more_png.dart';
import 'package:awjq/page/more_and_more_normal.dart';
import 'package:awjq/page/more_and_more_nvel.dart';
import 'package:awjq/pages/community/community_issue.dart';
import 'package:awjq/pages/community/community_post_detail.dart';
import 'package:awjq/pages/community/community_tag_detail.dart';
import 'package:awjq/pages/community/community_tags_all.dart';
import 'package:awjq/pages/mine/agent/mine_agent_apply_page.dart';
import 'package:awjq/pages/mine/agent/mine_agent_bankcard_list_page.dart';
import 'package:awjq/pages/mine/agent/mine_agent_cash_record_page.dart';
import 'package:awjq/pages/mine/agent/mine_agent_invite_record_page.dart';
import 'package:awjq/pages/mine/agent/mine_agent_page.dart';
import 'package:awjq/pages/mine/agent/mine_agent_profit_list_page.dart';
import 'package:awjq/pages/mine/agent/mine_agent_promotedata_page.dart';
import 'package:awjq/pages/mine/agent/mine_agent_rule_page.dart';
import 'package:awjq/pages/mine/agent/mine_agent_tocash_page.dart';
import 'package:awjq/pages/mine/buy_page.dart';
import 'package:awjq/pages/mine/mine_creater_apply.dart';
import 'package:awjq/pages/mine/mine_creater_center.dart';
import 'package:awjq/pages/mine/fans_follow_index.dart';
import 'package:awjq/pages/mine/mine_creater_collect.dart';
import 'package:awjq/pages/mine/mine_creater_collect_detail.dart';
import 'package:awjq/pages/mine/mine_creater_collect_rate.dart';
import 'package:awjq/pages/mine/mine_creater_issue.dart';
import 'package:awjq/pages/mine/mine_creater_issue_rule.dart';
import 'package:awjq/pages/mine/mine_ncome_detailed.dart';
import 'package:awjq/pages/mine/mine_post_status.dart';
import 'package:awjq/pages/mine/mine_user_center_episode.dart';
import 'package:awjq/pages/rank/rank.dart';
import 'package:awjq/pages/search_main_page.dart';
import 'package:awjq/pages/search_result_page.dart';
import 'package:awjq/utils/app_route_observer.dart';
import 'package:awjq/global.dart';
import 'package:awjq/pages/details/atlas_detail.dart';
import 'package:awjq/pages/details/atlas_list.dart';
import 'package:awjq/pages/details/novel_detail.dart';
import 'package:awjq/pages/details/novel_reader.dart';
import 'package:awjq/pages/details/video_detail.dart';
import 'package:awjq/pages/login/index.dart';
import 'package:awjq/pages/mine/down_page.dart';
import 'package:awjq/pages/mine/fill_code.dart';
import 'package:awjq/pages/mine/invite_recored.dart';
import 'package:awjq/pages/mine/message_center.dart';
import 'package:awjq/pages/mine/notice_message.dart';
import 'package:awjq/page/kwantsharetousers.dart';
import 'package:awjq/pages/mine/vip_page.dart';
import 'package:awjq/pages/mine/watch_history.dart';
import 'package:awjq/pages/mine/app_center.dart';
import 'package:awjq/pages/mine/coinrecharge.dart';
import 'package:awjq/pages/mine/coin_detail.dart';
import 'package:awjq/pages/mine/contact_official.dart';
import 'package:awjq/pages/mine/customer_service.dart';
import 'package:awjq/pages/mine/online_service.dart';
import 'package:awjq/pages/mine/recharg_record.dart';
import 'package:awjq/pages/mine/setup.dart';
import 'package:awjq/pages/welcome.dart';
import 'package:awjq/pages/mine/invite_friends.dart';
...
class Routes {
  ...
  static String communitymarketissue = 'communitymarketissue'; //产品发布
  static String communitytagdetail =
      'communitytagdetail/:topic_id/:type'; //话题详情
  ...
  static GoRouter init() {
    List<GoRoute> rootRoutes = [
      ...
      GoRoute(
        path: communitymarketissue,
        builder: (context, state) {
          return CommunityMarketIssue();
        },
        routes: getDetailRoutes(),
      ),
      GoRoute(
